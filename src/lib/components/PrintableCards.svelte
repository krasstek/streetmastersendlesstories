<script>
  ...
  function resizeCards() {
    ...
    epilogues.forEach(el => {
      resizeElementToFit(el, 10, 1.2, 0.5);
    });

    const epilogueTitles = document.querySelectorAll('.card-storycardback-epiloguetitle');
...
<div class="printable-cards">
  ...
  <div class = "card-both-sides">
            ...
            <div class = "print-card-container">
                ...
                <div class = "card-storycardback-colorbar-back" style = "top: 4.54cm"></div>
                <div class = "card-storycardback-colorbar-red" style = "top: 4.54cm"></div>
  ...
  {#each cardtexts as card, index}
   <div class = "card-both-sides">
            ...
            <div class = "print-card-container">
                <div class = "card-storycardback-bar-top"></div>
                <div class = "card-storycard-divider" style = "height: 0.4px"></div>
                ...
                <div class = "card-storycardback-titlebar" style = "top: 3.8mm">
                        <div class = "card-storycardback-epiloguetitle">{@html card.wincondition[0]}</div>
                </div>
                <div class = "card-storycardback-colorbar-back" style = "top: 5.7mm"></div>
                <div class = "card-storycardback-colorbar-green" style = "top: 5.7mm"></div>
                ...
                <div class = "card-storycardback-titlebar" style = "top: 4.35cm">
                        <div class = "card-storycardback-epiloguetitle">{@html card.wincondition[1]}</div>
                </div>
                <div class = "card-storycardback-colorbar-back" style = "top: 4.54cm"></div>
                <div class = "card-storycardback-colorbar-red" style = "top: 4.54cm"></div>
                <div class = "card-storycard-divider"></div>
                <div class = "card-storycardback-bar-bottom">
                    <div class = "card-storycardback-bottomtitle">PART {@html card.chapter} EPILOGUE</div>
                </div>
            </div>
            </div>
  {/each}
...
.card-both-sides {
    ...
    .card-storycardback-titlebar{
        ...
        clip-path: polygon(0 0, 100% 0%, 100% 32%, 80.5% 32%, 75.5% 100%, 24.5% 100%, 19.5% 32%, 0% 32%);
        background: linear-gradient(90deg, rgba(130,130,130,1) 0%, rgba(255,255,255,1) 37%, rgba(255,255,255,1) 53%, rgba(130,130,130,1) 100%);
        position: absolute;
        z-index: 2;
    }
    ...
    .card-storycardback-epiloguetitle {
        ...
        clip-path: polygon(0 0, 100% 0%, 100% 20%, 80% 20%, 75% 100%, 25% 100%, 20% 20%, 0% 20%);
        z-index: 2;
        text-align: center;
        overflow: hidden;
    }
