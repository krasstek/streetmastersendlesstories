...
export function getEnemies(expansionfilter) {
    let enemies = [
        ...
        {
            name: "All-Heaven Gang", expansion: "tideofthedragon", showdown: "tideofthedragon", boss: "Train", bosstitle: _.template('${randFrom(["multibillionaire","hard-hearted","ruthless","determined"])} ${randFrom(["CEO","businessman","monk","dragon head","triad leader"])}'), gender: "male", desc: () => "the covert triad", addressing: "fools", minions: _.template("cultists, triads and convicts"), threat: "draws his finger under his chin", minionnames: ["Reina", "Big Dragon", "Goliath"], preparedboss: [["Heightened Reflexes", "and put it into play"]],
            gloat: [
...

        {
            ...
            ]), addressing: "mutts", minions: _.template("${randFrom([`menacing`,`stone-hearted`,`dangerous`])} ${randFrom([`mobsters`,`hitmen`,`suits`])}"), threat: "slowly adjusts his leather gloves while staring at you", minionnames: ["Tommy", "Bonnie", "The Plumber"], preparedboss: [["Increased Protection", "and put it into play"]], execution: function(contact) {randFrom([
                "pulls a sleek pistol from his coat, and fires once. The shot cracks like a closing door, and the ${gPron(contact, 'sex')} collapses sideways, lifeless before he hits the floor", "produces a boxcutter and slices the ${gPron(contact, 'sex')}'s throat"
            ])},
            gloat: [
...

        {
            ...
            ]), addressing: "interlopers", minions: _.template("ruthless triads and yakuza"), threat: "lifts his hand, dark, malevolent energy flaring on his fist", minionnames: ["Jin", "Dao", "Wan Bo"], preparedboss: [["Merciless Clutch", "and put it into play"]],
            gloat: [
        ...
        {
            name: "Nahualli", expansion: "stretchgoals17", showdown: "rumblepack", boss: "Tlazolteotl", bosstitle: _.template('Aztec ${randFrom(["goddess of death", "empress", "sorcerer"])}'), gender: "female", desc: () => randFrom(["the ancient force of restless warriors","the reawakened dead of the Afflicted Realm"]), addressing: "mortals", minions: _.template('${randFrom(["necromancers", "ancient callers", "pale wizards"])} and ${randFrom(["shambling cadavers", "walking dead", "rotten corpses"])}'), threat: "reaches for you, fingers spread wide, purple arcane energy crackling between them", minionnames: ["Pale Caller", "Pale Caller"], preparedboss: [["Decaying Blast", "and play it"]], execution: function(contact) {randFrom(["touches the ${gPron(contact, 'sex')}, killing him instantly"])}, pit: "a yawning portal of purple energy",
            gloat: [
        ...
        {
            name: "Silver Phoenix", expansion: "lamentofthebloodmoon", also: "tideofthedragon", showdown: "none", boss: "Caitlyn", bosstitle: _.template('${randFrom(["vengeful","tenacious","patient"])} empress'), gender: "female", desc: () => "the legacy of syndicates reborn as one", addressing: "pawn", minions: _.template("${randFrom([`elite`,`ruthless`,`trained`])} ${randFrom([`killers`,`soldiers`])}"), threat: "draws a line through the air with her finger — across her throat, just for you", minionnames: ["Reina", "Marionette Doll", "Lucille"], preparedboss: [["Blade Shield", "and put it into play"]], gloat: [
